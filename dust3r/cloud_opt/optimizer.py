...
# HONSUK ADDED
from dust3r.cloud_opt.init_im_poses import init_minimum_spanning_tree, rigid_points_registration, fast_pnp, align_multiple_poses
...
class PointCloudOptimizer(BasePCOptimizer):
    ...
    def __init__(self, *args, optimize_pp=False, focal_break=20, shared_focal=False, flow_loss_fn='smooth_l1', flow_loss_weight=0.0, 
                 ...
                 sintel_ckpt=False, use_self_mask=False, pxl_thre=50, sam2_mask_refine=False, motion_mask_thre=0.35, raft_ckpt_path = "ckpt_raft/Tartan-C-T-TSKH-spring540x960-M.pth", 
                 sam2_ckpt_path="ckpt_sam2/sam2.1_hiera_large.pt", batchify=True, **kwargs):
        ...
        self.raft_ckpt_path = raft_ckpt_path
        self.sam2_checkpoint = sam2_ckpt_path
    ...
    def get_flow(self, sintel_ckpt=False): #TODO: test with gt flow
        ...
        flow_net = load_RAFT(self.raft_ckpt_path)
